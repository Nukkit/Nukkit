...
public class Enchantment implements Cloneable{
	...
	public static final byte TYPE_ARMOR_PROTECTION = 0;
	public static final byte TYPE_ARMOR_FIRE_PROTECTION = 1;
	public static final byte TYPE_ARMOR_FALL_PROTECTION = 2;
	public static final byte TYPE_ARMOR_EXPLOSION_PROTECTION = 3;
	public static final byte TYPE_ARMOR_PROJECTILE_PROTECTION = 4;
	public static final byte TYPE_ARMOR_THORNS = 5;
	public static final byte TYPE_WATER_BREATHING = 6;
	public static final byte TYPE_WATER_SPEED = 7;
	public static final byte TYPE_WATER_AFFINITY = 8;
	public static final byte TYPE_WEAPON_SHARPNESS = 9;
	public static final byte TYPE_WEAPON_SMITE = 10;
	public static final byte TYPE_WEAPON_ARTHROPODS = 11;
	public static final byte TYPE_WEAPON_KNOCKBACK = 12;
	public static final byte TYPE_WEAPON_FIRE_ASPECT = 13;
	public static final byte TYPE_WEAPON_LOOTING = 14;
	public static final byte TYPE_MINING_EFFICIENCY = 15;
	public static final byte TYPE_MINING_SILK_TOUCH = 16;
	public static final byte TYPE_MINING_DURABILITY = 17;
	public static final byte TYPE_MINING_FORTUNE = 18;
	public static final byte TYPE_BOW_POWER = 19;
	public static final byte TYPE_BOW_KNOCKBACK = 20;
	public static final byte TYPE_BOW_FLAME = 21;
	public static final byte TYPE_BOW_INFINITY = 22;
	public static final byte TYPE_FISHING_FORTUNE = 23;
	public static final byte TYPE_FISHING_LURE = 24;

	public static final byte RARITY_COMMON = 0;
	public static final byte RARITY_UNCOMMON = 1;
	public static final byte RARITY_RARE = 2;
	public static final byte RARITY_MYTHIC = 3;

	public static final byte ACTIVATION_EQUIP = 0;
	public static final byte ACTIVATION_HELD = 1;
	public static final byte ACTIVATION_SELF = 2;

	public static final byte SLOT_NONE = 0;
	...
	public static Enchantment getEnchantment(byte id) {
        int i = id & 0xff;
        if (i >= 0 && i < enchantments.length && enchantments[i] != null) {
            return enchantments[i].clone();
        } else {
            return null;
        }
    }
	...
	public static Enchantment getEnchantmentByName(String name){
		try {
            byte id = Enchantment.class.getField(name.toUpperCase()).getByte(null);
	...
	private Enchantment(byte id, String name, byte rarity, byte activationType, int slot){
		this.id = id;
		this.name = name;
		this.rarity = rarity;
	...
	public boolean hasSlot(byte slot){
