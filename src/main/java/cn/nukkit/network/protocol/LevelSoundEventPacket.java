...
public class LevelSoundEventPacket extends DataPacket {
    ...
    public static final int SOUND_SHULKERBOX_OPEN = 62;
    public static final int SOUND_SHULKERBOX_CLOSED = 63;
    public static final int SOUND_POWER_ON = 64;
    public static final int SOUND_POWER_OFF = 65;
    public static final int SOUND_ATTACH = 66;
    public static final int SOUND_DETACH = 67;
    public static final int SOUND_DENY = 68;
    public static final int SOUND_TRIPOD = 69;
    public static final int SOUND_POP = 70;
    public static final int SOUND_DROP_SLOT = 71;
    public static final int SOUND_NOTE = 72;
    public static final int SOUND_THORNS = 73;
    public static final int SOUND_PISTON_IN = 74;
    public static final int SOUND_PISTON_OUT = 75;
    public static final int SOUND_PORTAL = 76;
    public static final int SOUND_WATER = 77;
    public static final int SOUND_LAVA_POP = 78;
    public static final int SOUND_LAVA = 79;
    public static final int SOUND_BURP = 80;
    public static final int SOUND_BUCKET_FILL_WATER = 81;
    public static final int SOUND_BUCKET_FILL_LAVA = 82;
    public static final int SOUND_BUCKET_EMPTY_WATER = 83;
    public static final int SOUND_BUCKET_EMPTY_LAVA = 84;
    public static final int SOUND_GUARDIAN_FLOP = 85;
    public static final int SOUND_ELDERGUARDIAN_CURSE = 86;
    public static final int SOUND_MOB_WARNING = 87;
    public static final int SOUND_MOB_WARNING_BABY = 88;
    public static final int SOUND_TELEPORT = 89;
    public static final int SOUND_SHULKER_OPEN = 90;
    public static final int SOUND_SHULKER_CLOSE = 91;
    public static final int SOUND_HAGGLE = 92;
    public static final int SOUND_HAGGLE_YES = 93;
    public static final int SOUND_HAGGLE_NO = 94;
    public static final int SOUND_HAGGLE_IDLE = 95;
    public static final int SOUND_CHORUSGROW = 96;
    public static final int SOUND_CHORUSDEATH = 97;
    public static final int SOUND_GLASS = 98;
    public static final int SOUND_CAST_SPELL = 99;
    public static final int SOUND_PREPARE_ATTACK = 100;
    public static final int SOUND_PREPARE_SUMMON = 101;
    public static final int SOUND_PREPARE_WOLOLO = 102;
    public static final int SOUND_FANG = 103;
    public static final int SOUND_CHARGE = 104;
    public static final int SOUND_CAMERA_TAKE_PICTURE = 105;
    public static final int SOUND_DEFAULT = 106;
    public static final int SOUND_UNDEFINED = 107;
